...
namespace Admin_Panel.Pagginations
{
    ...
    public static class Paggination<T>
    {
        ...
        public static PagiData<T> GetData(int currentPage, int limit = 10, int cntBetween = 5, int middleVal = 10, IEnumerable<T> itemsData = null)
        {
            ...
            return new PagiData<T>() { CurrentPage = currentPage, Items = items, EndPage = endPage, StartPage = startPage, Pages = pages, TotalPages = totalPages };
        }
    }
}
